	...
	var mdDateTimePicker = (function () {
		...
		function mdDateTimePicker(_ref) {
			var type = _ref.type,
				...
				past =
					_ref$past === undefined
						? (0, _moment2.default)().subtract(21, "years")
						: _ref$past,
				...
				orientation =
					_ref$orientation === undefined ? "LANDSCAPE" : _ref$orientation,
				...
				prevHandle =
					_ref$prevHandle === undefined
						? '<div class="mddtp-prev-handle"></div>'
						: _ref$prevHandle,
				_ref$nextHandle = _ref.nextHandle,
				nextHandle =
					_ref$nextHandle === undefined
						? '<div class="mddtp-next-handle"></div>'
						: _ref$nextHandle;
			...
			[
				...
				},
				{
					...
					value: function _buildDialog() {
						...
						if (this._type === "date") {
							...
							AM.textContent = (0, _moment2.default)()
								.localeData()
								.meridiem(1, 1, !0);
							this._addId(PM, "PM");
							//PM.textContent = 'PM'
							// Change to 'PM' to Locale Meridiem
							PM.textContent = (0, _moment2.default)()
								.localeData()
								.meridiem(13, 1, !0);
				...
				},
				{
					...
					value: function _initViewHolder() {
						...
						this._initMonth(
							previous,
							(0, _moment2.default)(this._getMonth(m, -1))
						);
						this._toMoveMonth();
					}
				},
				{
					...
					value: function _initMonth(view, m) {
						...
						var docfrag = document.createDocumentFragment(),
							tr = innerDivs[3],
							firstDayOfMonth = _moment2.default
								.weekdays(!0)
								.indexOf(
									_moment2.default.weekdays(
										!1,
										(0, _moment2.default)(m).date(1).day()
									)
								),
							today = -1,
							selected = -1,
							lastDayOfMonth =
								parseInt(
									(0, _moment2.default)(m).endOf("month").format("D"),
									10
								) +
								firstDayOfMonth -
								1,
						...
						if (!mdDateTimePicker.dialog.view) {
							...
							if (me._autoClose !== !0) {
								...
								setTimeout(function () {
									...
									fakeNeedle.setAttribute(
										"style",
										"left:" +
										(cOffset.left - hOffset.left) +
										"px;top:" +
										(cOffset.top - hOffset.top) +
										"px"
									);
								}, 300);
							}
						...
						if (this._type == "date") {
							...
							if (this._inner24 === !0 && me._mode) {
								if (parseInt(me._sDialog.sDate.format("H"), 10) > 12) {
									me._sDialog.needle.classList.add(
										"mddtp-picker__cell--rotate24"
									);
								} else {
									me._sDialog.needle.classList.remove(
										"mddtp-picker__cell--rotate24"
									);
								}
							}
				...
				},
				{
					...
					value: function _changeM() {
						...
						AM.onclick = function (e) {
							...
							var m = "AM";
							if (
								me._sDialog.sDate._locale.isPM(me._sDialog.sDate.format("A"))
							) {
								m = "PM";
							}
							if (m === "PM") {
				...
				},
				{
					...
					value: function _dragDial() {
						...
						var onDragEnd = function onDragEnd(e) {
							var minuteViewChildren = me._sDialog.minuteView.getElementsByTagName(
								"div"
								),
								sMinute = "mddtp-minute__selected",
								selectedMinute = document.getElementById(sMinute),
